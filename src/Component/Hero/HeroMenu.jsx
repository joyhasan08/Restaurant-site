...
const HeroMenu = () => {
    return (
        <div>
            <section>
                <div className="dark:bg-violet-400 bg-orange-300 pt-4 mb-4 rounded-b-lg">
                    <div className="container flex flex-col items-center   px-4 py-16 pb-24 mx-auto text-center lg:pb-20 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
